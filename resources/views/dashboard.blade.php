        ...
        <div class="flex justify-between items-center bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-400 font-medium">
                    Información actualizada al: <span class="text-gray-900 dark:text-gray-100">23 sept 2025</span>
                </span>
            </div>
            <flux:button variant="primary" color="sky" class="shadow-lg hover:shadow-xl transition-shadow duration-200" href="{{ route('admin.upload') }}" wire:navigate>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-900 dark:text-gray-100">Juan Pérez</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-900 dark:text-gray-100">María González</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-900 dark:text-gray-100">Carlos Rodríguez</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
