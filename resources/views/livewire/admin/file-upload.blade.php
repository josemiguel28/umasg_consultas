<div>
    <div class="flex h-full w-full flex-1 flex-col gap-8 p-6 bg-gray-50 dark:bg-gray-900">
        ...
        <!-- Header -->
        <div class="flex items-center justify-between bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <form wire:submit="upload" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <flux:field>
                            ...
                            <!-- Drag & Drop Area -->
                            <div 
                                class="relative border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-colors duration-200"
                                x-data="{ 
                                    isDragging: false,
                                    fileName: null
                                }"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="space-y-2">
                                        <p class="text-lg font-medium text-gray-700 dark:text-gray-300">
                                            ...
                                            <button type="button" class="text-blue-600 dark:text-blue-400 underline hover:text-blue-700" @click="$refs.fileInput.click()">
                                                selecciona uno
                                            </button>
                                        </p>
                                    ...
                                    <!-- Selected File Info -->
                                    <div x-show="fileName" class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mt-4">
                                        <div class="flex items-center gap-2">
                                            <svg class="w-5 h-5 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                            </svg>
                                            <span class="text-sm font-medium text-green-700 dark:text-green-300" x-text="fileName"></span>
                                            <button type="button" @click="fileName = null; $refs.fileInput.value = ''" class="ml-auto text-green-600 dark:text-green-400 hover:text-green-800">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <flux:field>
                            <flux:label>Descripción del archivo</flux:label>
                            <flux:textarea 
                        ...
                        <flux:field>
                            <flux:label>Opciones de procesamiento</flux:label>
                            <div class="space-y-3">
                                <flux:checkbox wire:model="skipFirstRow" label="Omitir primera fila (headers)" />
                                <flux:checkbox wire:model="validateData" label="Validar datos antes de importar" />
                                <flux:checkbox wire:model="sendNotification" label="Enviar notificación al completar" />
                            </div>
                        </flux:field>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        >
                            ...
                            <span wire:loading.remove wire:target="upload">Subir e importar archivo</span>
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <ul class="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                        ...
                        <li>• Primera fila debe contener los headers de las columnas</li>
